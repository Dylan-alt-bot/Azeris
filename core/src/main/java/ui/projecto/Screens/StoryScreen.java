...
public class StoryScreen implements Screen {
    ...
    public void show() {
        ...
        slides[0] = new Texture("pantalla/historia/principio/1.png");
        slides[1] = new Texture("pantalla/historia/principio/2.png");
        slides[2] = new Texture("pantalla/historia/principio/3.png");
        fadeAlpha = 1f;
        state = State.FADE_IN;
        slideTimer = 0f;
    }
